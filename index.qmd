...
<div class="hero">
  ...
  <div class="hero-content">
    ...
    <p class="subtitle">Watershed Scientist &nbsp;·&nbsp; Hydrologist &nbsp;·&nbsp; PhD Candidate</p>
    <p class="tagline">Snow, fire, and the watersheds that connect them.</p>
  </div>
</div>
...
<div class="section">
  ...
  <div class="about-grid">
    ...
    <div>
      <p>
        I'm a watershed scientist and a hydrologist working at the intersection of 
        post-fire hydrology, remote sensing, and snow hydrology. I grew up in Alaska 
        and have spent my career chasing water across the West, from Arctic streams to 
        desert arroyos to the fire-scarred forests of the Eastern Cascades.
      </p>
      <p>
        I currently serve as a Watershed Project Manager, BAER Coordinator, and 
      ...
      <p>
        When I'm not in the field or staring at data, you can find me on long trail 
        runs in the mountains or on any kind of ski.
      </p>
      <div class="badge-row">
